...
const ViewDetected: FunctionComponent<ViewDetectedProps> = ({
  deviceType,
  ...props
}) => {
  return (
    <ViewDetectedContext.Provider value={{ deviceType }}>
      {props.children}
...
export const ViewMedia: FunctionComponent<ViewMediaProps> = ({
  is,
  dynamic,
  dynamicOptions,
  ...props
